...
class ZoteroIntegration:
    ...
    def __init__(self, library_path: Optional[str] = None, audit_log: Optional[AuditLog] = None):
        """初期化."""
...
class ScreenpipeIntegration:
    ...
    def __init__(self, log_dir: Optional[str] = None, audit_log: Optional[AuditLog] = None):
        """初期化."""

...
class MetricsCollector:
    ...
    def __init__(self, base_path: str = "artifacts"):
        ...
        self._current_quality: Optional[QualityMetrics] = None
    ...
    def update_quality(
        self,
        provenance_rate: Optional[float] = None,
        pico_consistency_rate: Optional[float] = None,
        direction_consistency_rate: Optional[float] = None,

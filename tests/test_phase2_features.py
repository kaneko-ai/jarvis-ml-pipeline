...
class TestGRADESystem:
    ...
    def test_grade_assessment_dataclass(self):
        ...
        from jarvis_core.analysis.grade_system import GRADEAssessment, GRADELevel, StudyDesign
...
class TestCitationStance:
    ...
    def test_stance_result_dataclass(self):
        ...
        from jarvis_core.analysis.citation_stance import CitationStance, StanceResult
    ...
    def test_rule_classifier_support(self):
        ...
        from jarvis_core.analysis.citation_stance import CitationStance, RuleBasedStanceClassifier

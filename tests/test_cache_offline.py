...
class TestSQLiteCache:
    ...
    def test_cache_singleton(self):
        ...
        from jarvis_core.cache.sqlite_cache import get_cache, _default_cache
...
class TestOfflineManager:
    ...
    def test_force_offline(self):
        ...
        from jarvis_core.runtime.offline_manager import (
            OfflineManager, ConnectivityState
        )
    ...
    def test_get_offline_manager_singleton(self):
        ...
        from jarvis_core.runtime.offline_manager import (
            get_offline_manager, _default_manager
        )

...
class TestPRISMAGenerator:
    ...
    def test_prisma_diagram_dataclass(self):
        ...
        from jarvis_core.reporting.prisma_generator import (
            PRISMADiagram, PRISMAStats
        )
...
class TestActiveLearning:
    ...
    def test_labeled_sample_dataclass(self):
        ...
        from jarvis_core.learning.active_learning import LabeledSample, Label

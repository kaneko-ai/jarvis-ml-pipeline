...
from jarvis_core.trend.ranker import RankScore, TrendRanker
...
class TestTrendReport:
    def test_to_markdown(self):
        item = TrendItem(
            id="1", title="Test Trend", source="mock", 
            url="http://test", abstract="Abstract", published_date="2024-01-01"
        )
...
class TestTrendWatcher:
    ...
    def test_collect(self, watcher):
        item1 = TrendItem(id="1", title="T1", source="s1", url="u1", abstract="a1", published_date="d1")
        item2 = TrendItem(id="2", title="T2", source="s2", url="u2", abstract="a2", published_date="d2")
        # Duplicate item
        item3 = TrendItem(id="1", title="T1", source="s1", url="u1", abstract="a1", published_date="d1")
    ...
    def test_generate_report(self, watcher):
        item = TrendItem(id="1", title="T1", source="s1", url="u1", abstract="a1", published_date="d1")

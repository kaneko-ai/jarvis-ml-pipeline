...
class TestRootModulesImport:
    ...
    @pytest.mark.parametrize("module_name", [
        "bibtex", "bundle", "bundle_layout", "career_planner", "chain_builder",
        "clinical_readiness", "comparison", "competing_hypothesis", "cross_field",
        "education", "failure_simulator", "feasibility", "funding_cliff",
        "gap_analysis", "grant_optimizer", "heatmap", "hypothesis",
        "journal_targeting", "kill_switch", "knowledge_graph", "lab_culture",
        "lab_optimizer", "lab_to_startup", "lambda_modules", "living_review",
        "logic_citation", "meta_science", "method_trend", "model_system",
        "paradigm", "paper_vector", "pi_succession", "pi_support",
        "recommendation", "rehearsal", "reproducibility_cert", "reviewer_persona",
        "roi_engine", "sigma_modules", "student_portfolio", "thinking_engines",
        "timeline", "career_engines"
    ])

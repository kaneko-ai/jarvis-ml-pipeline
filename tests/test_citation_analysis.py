...
class TestStanceClassifier:
    ...
    def test_classify_support(self):
        ...
        from jarvis_core.citation import classify_citation_stance, CitationStance
    ...
    def test_stance_result_structure(self):
        ...
        from jarvis_core.citation.stance_classifier import StanceResult, CitationStance

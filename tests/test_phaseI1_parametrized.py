...
class TestGenerateReportParametrized:
    ...
    def test_create_conclusion_various_roles(self, role):
        ...
        evidence = [{"evidence_id": "e1", "evidence_role": role, "evidence_strength": "Strong"}] if role else []
...
class TestAdvancedFeaturesParametrized:
    ...
    def test_meta_analysis_various_sizes(self, num_studies):
        ...
        bot = MetaAnalysisBot()
        studies = [{"effect_size": 0.5 + i*0.1, "sample_size": 100 + i*10, "variance": 0.1} for i in range(num_studies)]
...
class TestIngestionPipelineParametrized:
    ...
    @pytest.mark.parametrize("chunk_size,overlap", [
        (50, 0), (50, 10), (100, 20), (200, 50), (500, 100)
    ])
    ...
    @pytest.mark.parametrize("entry_type", ["article", "book", "inproceedings", "misc", "phdthesis"])

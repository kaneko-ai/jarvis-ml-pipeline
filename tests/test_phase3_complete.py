...
class TestPerformanceUtils:
    ...
    def test_memory_manager(self):
        """Test memory manager."""
        from jarvis_core.utils.performance import MemoryManager, LazyLoader
...
class TestPhase3Complete:
    ...
    def test_all_phase3_modules(self):
        ...
        from jarvis_core.plugins.plugin_system import (
            Plugin, PluginRegistry, get_registry
        )
        from jarvis_core.plugins.zotero_integration import ZoteroClient
        from jarvis_core.plugins.sample_plugins import (
            BibtexExporterPlugin, JSONExporterPlugin
        )
        
        # Performance
        from jarvis_core.utils.performance import (
            measure_performance, BatchProcessor, MemoryManager
        )

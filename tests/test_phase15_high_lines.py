...
class TestNoteGeneratorFunctional:
    ...
    def test_extract_locator_alternate_keys(self):
        ...
        locator = {"Section": "Results", "paragraph": 1, "sentence": 2, "chunk": "c2"}
        section, para, sent, chunk = _extract_locator(locator)
...
class TestRISBibTeXFunctional:
    ...
    def test_reference_creation(self):
        ...
        ref = Reference(id="ref1", title="Test Title", authors=["Author 1"], year=2024)
    ...
    def test_reference_to_dict(self):
        ...
        ref = Reference(
            id="ref1", title="Test Title", authors=["Author 1"], year=2024, journal="Test Journal"
        )
        d = ref.to_dict()

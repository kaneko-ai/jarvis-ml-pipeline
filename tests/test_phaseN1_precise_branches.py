...
class TestSummarizationRefutable:
    ...
    def test_with_fact_claims_and_evidence(self, mock_log):
        ...
        claim = Claim(
            ...
            claim_type="fact",
            evidence=[EvidenceLink(doc_id="p1", section="intro", chunk_id="ch1", start=0, end=10, confidence=0.9)]
        )
...
class TestScoringImportance:
    ...
    def test_with_novel_and_significant(self, mock_log):
        ...
        artifacts = Artifacts()
        artifacts.papers = [
            Paper(doc_id="p1", title="Novel Approach", abstract="This novel and significant study is the first of its kind")
        ]
...
class TestScoringBiasRisk:
    ...
    def test_all_risk_modifiers(self, mock_log):
        ...
        artifacts.papers = [
            Paper(doc_id="p1", title="RCT", abstract="This randomized control trial was funded by government")
        ]
...
class TestScoringClinicalRelevance:
    ...
    def test_with_clinical_keywords(self, mock_log):
        ...
        artifacts = Artifacts()
        artifacts.papers = [
            Paper(doc_id="p1", title="Clinical Trial", abstract="Patient treatment and therapy outcomes")
        ]
...
class TestScoringPersonalFit:
    ...
    def test_high_overlap(self, mock_log):
        ...
        artifacts = Artifacts()
        artifacts.papers = [
            Paper(doc_id="p1", title="Machine Learning Cancer Detection")
        ]
...
class TestScoringLearningROI:
    ...
    def test_with_existing_scores(self, mock_log):
        ...
        artifacts.scores["p1_personal_fit"] = Score(name="personal_fit", value=0.6, explanation="test")

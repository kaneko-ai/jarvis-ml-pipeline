...
class TestExtractClaimsFunction:
        ...
        papers = [
            {
                ...
                "abstract": f"Abstract for paper {i} with sufficient content to extract claims.",
            }
            for i in range(10)
        ]
        result = extract_claims(papers)
    ...
    def test_extract_claims_with_kwargs(self):
        ...
        papers = [
            {"paper_id": "p1", "title": "Test", "abstract": "Test abstract with enough text."}
        ]
        ...
        papers = [
            {
                "paper_id": "test_paper",
                "title": "Test Title",
                "abstract": "A sufficiently long abstract for testing claim extraction.",
            }
        ]
        result = extract_claims(papers)
        if result["claims"]:
...
class TestFindEvidenceFunction:
    ...
    def test_find_evidence_no_matching_papers(self):
        ...
        claims = [{"claim_id": "c1", "claim_text": "Test claim", "source_paper_id": "nonexistent"}]
        papers = {}
    ...
    def test_find_evidence_with_matching_paper(self):
        ...
        claims = [{"claim_id": "c1", "claim_text": "Test claim text", "source_paper_id": "paper_1"}]
        papers = {
...
class TestCalculateEvidenceStrength:
    ...
    def test_strong_evidence(self):
        ...
        evidence = {"paper_id": "p1", "quote_span": "A" * 150, "evidence_role": "Direct"}
    ...
    def test_medium_evidence(self):
        ...
        evidence = {"paper_id": "p2", "quote_span": "A" * 80, "evidence_role": "Direct"}
        claim = {"source_paper_id": "p1"}
        strength = calculate_evidence_strength(evidence, claim)
    ...
    def test_weak_evidence(self):
        ...
        evidence = {"paper_id": "p2", "quote_span": "A" * 30, "evidence_role": "Other"}
        claim = {"source_paper_id": "p1"}
        strength = calculate_evidence_strength(evidence, claim)
    ...
    def test_no_evidence(self):
        ...
        evidence = {"paper_id": "p2", "quote_span": "Short", "evidence_role": "Other"}
        claim = {"source_paper_id": "p1"}
        strength = calculate_evidence_strength(evidence, claim)

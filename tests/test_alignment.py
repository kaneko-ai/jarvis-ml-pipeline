...
class TestCalculateTokenOverlap:
    def test_full_overlap(self):
        overlap = calculate_token_overlap("drug treatment effective", "drug treatment effective")
        assert overlap == 1.0

    def test_partial_overlap(self):
        overlap = calculate_token_overlap("drug treatment therapy", "drug therapy medicine")
        assert 0 < overlap < 1

    def test_no_overlap(self):
        overlap = calculate_token_overlap("apple banana cherry", "house car bicycle")
        assert overlap == 0.0

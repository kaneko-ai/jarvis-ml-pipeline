...
class TestStagesRetrievalExtractionBranches:
    ...
    def test_import_all_functions(self):
        ...
        funcs = [name for name in dir(retrieval_extraction) if callable(getattr(retrieval_extraction, name)) and not name.startswith('_')]
...
class TestStagesGenerateReportBranches:
    ...
    def test_calculate_overall_confidence_all_levels(self):
        ...
        # All Strong
        r1 = calculate_overall_confidence([{"evidence_strength": "Strong"}, {"evidence_strength": "Strong"}])
        assert r1 is not None
        
        # Mixed
        r2 = calculate_overall_confidence([{"evidence_strength": "Strong"}, {"evidence_strength": "Weak"}])
    ...
    def test_build_reference_list_various_papers(self):
        ...
        papers = [
            {"paper_id": "p1", "title": "Paper 1", "authors": ["A", "B"], "year": 2024, "doi": "10.1234/p1"},
            {"paper_id": "p2", "title": "Paper 2", "authors": ["C"], "year": 2023},
            {"paper_id": "p3", "title": "Paper 3", "authors": ["D", "E", "F", "G"], "year": 2022, "url": "https://example.com"},
        ]
    ...
    def test_create_claim_section_all_types(self):
        ...
        evidence = [{"evidence_id": "e1", "evidence_strength": "Strong", "evidence_role": "supporting"}]
        paper_map = {}

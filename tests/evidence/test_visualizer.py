...
def test_generate_confidence_chart():
    ...
    grades = [
        EvidenceGrade(level=EvidenceLevel.LEVEL_1A, confidence=0.9, study_type=StudyType.META_ANALYSIS),
        EvidenceGrade(level=EvidenceLevel.LEVEL_1A, confidence=0.85, study_type=StudyType.META_ANALYSIS),
        EvidenceGrade(level=EvidenceLevel.LEVEL_2B, confidence=0.7, study_type=StudyType.COHORT_PROSPECTIVE),
        EvidenceGrade(level=EvidenceLevel.LEVEL_3B, confidence=0.6, study_type=StudyType.CASE_CONTROL),
    ]
...
def test_generate_summary_table():
    ...
    grades = [
        EvidenceGrade(level=EvidenceLevel.LEVEL_1A, confidence=0.9, study_type=StudyType.META_ANALYSIS, classifier_source="ensemble"),
    ]
